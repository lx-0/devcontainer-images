# Linux Universal Image (arm64 version)
...
## Modifications for arm64 architecture

This is a clone of the universal dev container image `mcr.microsoft.com/devcontainers/universal:2`. The original image does only support x64 architectures. This clone removes the `conda` feature to be usable on arm64 architectures.
